...
foreach my $f (
  qw/new delete difference is_disjoint empty intersect
...
subtest 'Tested intersect()' => sub {
  ...
  ok( set( 1 .. 10 )->intersect( set( 5 .. 10 ) )->is_equal( set( 5 .. 10 ) ),
  ...
  ok( set( 1, 3, 5, 7, 9 )->intersect( set( 3 .. 7 ) )->is_equal( set( 3, 5, 7 ) ),
...
subtest 'Tested difference()' => sub {
  ...
  ok( set( 1 .. 10, 20 .. 30 )->difference( set( 5 .. 25 ) )->is_equal( set( 1 .. 4, 26 .. 30 ) ),
    "large difference" );
};
...
subtest 'Tested union()' => sub {
  ...
  ok( set( 1 .. 10, 20 .. 30 )->union( set( 5 .. 25 ) )->is_equal( set( 1 .. 30 ) ),
    "large union" );
};
