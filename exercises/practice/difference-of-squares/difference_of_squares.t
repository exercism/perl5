...
can_ok $module, "sum_of_squares"
  or BAIL_OUT
  "Missing package $module; or missing sub sum_of_squares()";

can_ok $module, "square_of_sum"
  or BAIL_OUT
  "Missing package $module; or missing sub square_of_sum()";
...
is $module->new(100)->square_of_sum, 25_502_500,
  "square_of_sum to 100";
is $module->new(100)->sum_of_squares, 338_350,
  "sum_of_squares to 100";
