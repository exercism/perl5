...
$robot = Robot->new( x => 7, y => 3, direction => "north" )->enact("RAALAL"); # begin: e34ac672-4ed4-4be3-a0b8-d9af259cbaa1
is(
    $robot,
    object {
        call x         => 9;
...
$robot = Robot->new( x => 0, y => 0, direction => "north" )->enact("LAAARALA"); # begin: f30e4955-4b47-4aa3-8b39-ae98cfbd515b
is(
    $robot,
    object {
        call x         => -4;
...
$robot = Robot->new( x => 2, y => -7, direction => "east" )->enact("RRAAAAALA"); # begin: 3e466bf6-20ab-4d79-8b51-264165182fca
is(
    $robot,
    object {
        call x         => -3;
...
$robot = Robot->new( x => 8, y => 4, direction => "south" )->enact("LAAARRRALLLL"); # begin: 41f0bb96-c617-4e6b-acff-a4b279d44514
is(
    $robot,
    object {
        call x         => 11;
