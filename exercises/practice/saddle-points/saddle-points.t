...
is( # begin: 6d1399bd-e105-40fd-a2c9-c6609507d7a3
    ...
    bag { item { column => 2, row => 1 };
        item { column => 2, row => 2 };
        item { column => 2, row => 3 }; end; },
...
is( # begin: 3e81dce9-53b3-44e6-bf26-e328885fd5d1
    ...
    bag { item { column => 1, row => 2 };
        item { column => 2, row => 2 };
        item { column => 3, row => 2 }; end; },
...
is( # begin: 5b9499ca-fcea-4195-830a-9c4584a0ee79
    ...
    bag { item { column => 3, row => 1 };
        item { column => 1, row => 1 }; end; },
