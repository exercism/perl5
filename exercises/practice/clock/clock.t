...
is( Clock->new( hour => -121, minute => -5810 )->time,
    "22:10",
    "Create a new clock with an initial time: negative hour and minutes both roll over continuously",
);

is( Clock->new( hour => 10, minute => 0 )->add_minutes(3)->time,
    "10:03", "Add minutes: add minutes",
);

is( Clock->new( hour => 6, minute => 41 )->add_minutes(0)->time,
    "06:41", "Add minutes: add no minutes",
);

is( Clock->new( hour => 0, minute => 45 )->add_minutes(40)->time,
    "01:25", "Add minutes: add to next hour",
);

is( Clock->new( hour => 10, minute => 0 )->add_minutes(61)->time,
    "11:01", "Add minutes: add more than one hour",
);

is( Clock->new( hour => 0, minute => 45 )->add_minutes(160)->time,
    "03:25",
    "Add minutes: add more than two hours with carry",
);

is( Clock->new( hour => 23, minute => 59 )->add_minutes(2)->time,
    "00:01", "Add minutes: add across midnight",
);

is( Clock->new( hour => 5, minute => 32 )->add_minutes(1500)->time,
    "06:32",
    "Add minutes: add more than one day (1500 min = 25 hrs)",
);

is( Clock->new( hour => 1, minute => 1 )->add_minutes(3500)->time,
    "11:21", "Add minutes: add more than two days",
);

is( Clock->new( hour => 10, minute => 3 )->subtract_minutes(3)->time,
    "10:00", "Subtract minutes: subtract minutes",
);

is( Clock->new( hour => 10, minute => 3 )->subtract_minutes(30)->time,
    "09:33",
    "Subtract minutes: subtract to previous hour",
);

is( Clock->new( hour => 10, minute => 3 )->subtract_minutes(70)->time,
    "08:53",
    "Subtract minutes: subtract more than an hour",
);

is( Clock->new( hour => 0, minute => 3 )->subtract_minutes(4)->time,
    "23:59",
    "Subtract minutes: subtract across midnight",
);

is( Clock->new( hour => 0, minute => 0 )->subtract_minutes(160)->time,
    "21:20",
    "Subtract minutes: subtract more than two hours",
);

is( Clock->new( hour => 6, minute => 15 )->subtract_minutes(160)->time,
    "03:35",
    "Subtract minutes: subtract more than two hours with borrow",
);

is( Clock->new( hour => 5, minute => 32 )->subtract_minutes(1500)->time,
    "04:32",
    "Subtract minutes: subtract more than one day (1500 min = 25 hrs)",
);

is( Clock->new( hour => 2, minute => 20 )->subtract_minutes(3000)->time,
    "00:20",
    "Subtract minutes: subtract more than two days",
);

is( Clock->new( hour => 15, minute => 37 ),
