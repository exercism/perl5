...
$grade_school->add( "Aimee", 2 );    # begin: 6d0a30e4-1b4e-472e-8e20-c41702125667
is(
    $grade_school->roster,
    ["Aimee"],
...
$grade_school = GradeSchool->new;
$grade_school->add( "Blair", 2 );    # begin: 233be705-dd58-4968-889d-fb3c7954c9cc
$grade_school->add( "James", 2 );
$grade_school->add( "Paul",  2 );
is(
    $grade_school->roster,
...
$grade_school = GradeSchool->new;
$grade_school->add( "Blair", 2 );    # begin: d7982c4f-1602-49f6-a651-620f2614243a
$grade_school->add( "James", 2 );
$grade_school->add( "James", 2 );
$grade_school->add( "Paul",  2 );
is(
...
$grade_school = GradeSchool->new;
$grade_school->add( "Chelsea", 3 );    # begin: 75a51579-d1d7-407c-a2f8-2166e984e8ab
$grade_school->add( "Logan",   7 );
is(
    $grade_school->roster,
    [ "Chelsea", "Logan" ],
...
$grade_school = GradeSchool->new;
$grade_school->add( "Blair", 2 );    # begin: c7ec1c5e-9ab7-4d3b-be5c-29f2f7a237c5
$grade_school->add( "James", 2 );
$grade_school->add( "James", 3 );
$grade_school->add( "Paul",  3 );
is(
...
$grade_school = GradeSchool->new;
$grade_school->add( "Jim",   3 );    # begin: d9af4f19-1ba1-48e7-94d0-dabda4e5aba6
...
$grade_school = GradeSchool->new;
$grade_school->add( "Peter", 2 );    # begin: d9fb5bea-f5aa-4524-9d61-c158d8906807
...
$grade_school = GradeSchool->new;
$grade_school->add( "Peter",   2 );    # begin: 180a8ff9-5b94-43fc-9db1-d46b4a8c93b6
$grade_school->add( "Anna",    1 );
...
$grade_school = GradeSchool->new;
$grade_school->add( "Peter", 2 );      # begin: 1e0cf06b-26e0-4526-af2d-a2e2df6a51d6
$grade_school->add( "Zoe",   2 );
$grade_school->add( "Alex",  2 );
$grade_school->add( "Jim",   3 );
is(
...
$grade_school = GradeSchool->new;
$grade_school->add( "Blair", 2 );      # begin: 2bfc697c-adf2-4b65-8d0f-c46e085f796e
$grade_school->add( "James", 2 );
$grade_school->add( "James", 2 );
$grade_school->add( "Paul",  2 );
is(
...
$grade_school = GradeSchool->new;
$grade_school->add( "Blair", 2 );      # begin: 66c8e141-68ab-4a04-a15a-c28bc07fe6b9
$grade_school->add( "James", 2 );
$grade_school->add( "James", 3 );
$grade_school->add( "Paul",  3 );
is(
...
$grade_school = GradeSchool->new;
$grade_school->add( "Blair", 2 );      # begin: c9c1fc2f-42e0-4d2c-b361-99271f03eda7
$grade_school->add( "James", 2 );
$grade_school->add( "James", 3 );
$grade_school->add( "Paul",  3 );
is(
...
$grade_school = GradeSchool->new;
$grade_school->add( "Franklin", 5 );    # begin: 1bfbcef1-e4a3-49e8-8d22-f6f9f386187e
