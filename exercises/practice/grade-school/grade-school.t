...
is( $grade_school->roster, [], "Roster is empty when no student is added", );

$grade_school = GradeSchool->new;
is( $grade_school->add( "Aimee", 2 ), T, "Add a student", );

$grade_school = GradeSchool->new;
$grade_school->add( "Aimee", 2 );
is( $grade_school->roster, ["Aimee"], "Student is added to the roster", );

$grade_school = GradeSchool->new;
is( $grade_school->add( "Blair", 2 ),
    T, "Adding multiple students in the same grade in the roster",
);
is( $grade_school->add( "James", 2 ),
    T, "Adding multiple students in the same grade in the roster",
);
is( $grade_school->add( "Paul", 2 ),
    T, "Adding multiple students in the same grade in the roster",
);
...
$grade_school = GradeSchool->new;
is( $grade_school->add( "Blair", 2 ),
    T, "Cannot add student to same grade in the roster more than once",
);
is( $grade_school->add( "James", 2 ),
    T, "Cannot add student to same grade in the roster more than once",
);
is( $grade_school->add( "James", 2 ),
    DF, "Cannot add student to same grade in the roster more than once",
);
is( $grade_school->add( "Paul", 2 ),
    T, "Cannot add student to same grade in the roster more than once",
);
...
$grade_school = GradeSchool->new;
is( $grade_school->add( "Chelsea", 3 ),
    T, "Adding students in multiple grades",
);
is( $grade_school->add( "Logan", 7 ),
    T, "Adding students in multiple grades",
);
...
$grade_school = GradeSchool->new;
is( $grade_school->add( "Blair", 2 ),
    T, "Cannot add same student to multiple grades in the roster",
);
is( $grade_school->add( "James", 2 ),
    T, "Cannot add same student to multiple grades in the roster",
);
is( $grade_school->add( "James", 3 ),
    DF, "Cannot add same student to multiple grades in the roster",
);
is( $grade_school->add( "Paul", 3 ),
    T, "Cannot add same student to multiple grades in the roster",
);
...
$grade_school->add( "James", 3 );
$grade_school->add( "Paul",  3 );
is( $grade_school->roster(3),
    ["Paul"], "Student not added to other grade for multiple grades",
);
