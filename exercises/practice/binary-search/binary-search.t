...
is( binary_search( [6], 6 ),
    0, "finds a value in an array with one element",
);

is( binary_search( [ 1, 3, 4, 6, 8, 9, 11 ], 6 ),
    3, "finds a value in the middle of an array",
);

is( binary_search( [ 1, 3, 4, 6, 8, 9, 11 ], 1 ),
    0, "finds a value at the beginning of an array",
);

is( binary_search( [ 1, 3, 4, 6, 8, 9, 11 ], 11 ),
    6, "finds a value at the end of an array",
);
...
is( binary_search( [ 1, 3, 5, 8, 13, 21, 34, 55, 89, 144, 233, 377 ], 21 ),
    5, "finds a value in an array of even length",
);
