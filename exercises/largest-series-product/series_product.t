...
can_ok $module, "largest_product"
  or BAIL_OUT "Missing package $module, or missing sub largest_product()";

like dies { $module->new('012')->largest_product(4) }, qr/ArgumentError/,
...
is $module->new('52677741234314237566414902593461595376319419139427')->largest_product(6), 28350,
