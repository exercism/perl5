...
can_ok $module, "seconds"
  or BAIL_OUT "Missing package $module; or missing sub seconds()";

is $module->new(1_000_000)->seconds, 1_000_000,
  "attribute->seconds match constructor param";
